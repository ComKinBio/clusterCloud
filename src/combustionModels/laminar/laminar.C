...
namespace edmCombustionModels
{
    ...
    addToRunTimeSelectionTable(edmCombustionModel, laminar, dictionary);
}
}
...
Foam::edmCombustionModels::laminar::laminar
(
...
void Foam::edmCombustionModels::laminar::correct()
{
...
Foam::edmCombustionModels::laminar::R(volScalarField& Y) const
{
...
Foam::tmp<Foam::volScalarField> Foam::edmCombustionModels::laminar::Qdot() const
{
    return chemistryPtr_->Qdot();
}


bool Foam::edmCombustionModels::laminar::read()
{
