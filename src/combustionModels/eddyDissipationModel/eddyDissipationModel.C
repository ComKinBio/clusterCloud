...
Foam::edmCombustionModels::eddyDissipationModel::eddyDissipationModel
(
...
Foam::edmCombustionModels::eddyDissipationModel::rtDiff() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::edmCombustionModels::eddyDissipationModel::rtTurb() const
{
    return
...
void Foam::edmCombustionModels::eddyDissipationModel::correct()
{
    this->wFuel_ ==
...
bool Foam::edmCombustionModels::eddyDissipationModel::read()
{
