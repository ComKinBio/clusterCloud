...
void Foam::edmCombustionModels::singleStepCombustion::calculateqFuel()
{
...
void Foam::edmCombustionModels::singleStepCombustion::massAndAirStoichRatios()
{
...
void Foam::edmCombustionModels::singleStepCombustion::calculateMaxProducts()
{
    scalar Wm = 0.0;
    scalar totalMol = 0.0;
    forAll(reaction_.rhs(), i)
...
Foam::edmCombustionModels::singleStepCombustion::singleStepCombustion
(
...
:
    edmCombustionModel(modelType, thermo, turb, combustionProperties),
...
Foam::edmCombustionModels::singleStepCombustion::R(volScalarField& Y) const
{
...
Foam::edmCombustionModels::singleStepCombustion::Qdot() const
{
...
bool Foam::edmCombustionModels::singleStepCombustion::read()
{
...
void Foam::edmCombustionModels::singleStepCombustion::fresCorrect()
{
    const label O2Index = mixture_.species()["O2"];
