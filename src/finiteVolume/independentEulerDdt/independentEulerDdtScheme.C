...
template<class Type>
const volScalarField& independentEulerDdtScheme<Type>::localRDeltaT() const
{
    return independentEulerDdt::localRDeltaT(mesh());
}


template<class Type>
const surfaceScalarField& independentEulerDdtScheme<Type>::localRDeltaTf() const
{
    return independentEulerDdt::localRDeltaTf(mesh());
}


template<class Type>
tmp<GeometricField<Type, fvPatchField, volMesh>>
independentEulerDdtScheme<Type>::fvcDdt
(
...
template<class Type>
tmp<fvMatrix<Type>>
independentEulerDdtScheme<Type>::fvmDdt
(
    const GeometricField<Type, fvPatchField, volMesh>& vf
)
{
...
template<class Type>
tmp<surfaceScalarField> independentEulerDdtScheme<Type>::fvcDdtPhiCoeff
(
...
template<class Type>
tmp<typename independentEulerDdtScheme<Type>::fluxFieldType>
independentEulerDdtScheme<Type>::fvcDdtUfCorr
(
    const GeometricField<Type, fvPatchField, volMesh>& U,
...
template<class Type>
tmp<typename independentEulerDdtScheme<Type>::fluxFieldType>
independentEulerDdtScheme<Type>::fvcDdtPhiCorr
(
    const GeometricField<Type, fvPatchField, volMesh>& U,
    const fluxFieldType& phi
)
...
template<class Type>
tmp<surfaceScalarField> independentEulerDdtScheme<Type>::meshPhi
(
