...
#include "ClusterLookupTableInjection.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::ClusterLookupTableInjection<CloudType>::
ClusterLookupTableInjection
(
...
ClusterLookupTableInjection
(
    const ClusterLookupTableInjection<CloudType>& im
)
:
...
template<class CloudType>
void Foam::ClusterLookupTableInjection<CloudType>::updateMesh()
{
    // Set/cache the injector cells
    forAll(injectors_, i)
    {
...
template<class CloudType>
Foam::scalar
Foam::ClusterLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label
Foam::ClusterLookupTableInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar
Foam::ClusterLookupTableInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::ClusterLookupTableInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
...
template<class CloudType>
void Foam::ClusterLookupTableInjection<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar,
...
template<class CloudType>
bool
Foam::ClusterLookupTableInjection<CloudType>::fullyDescribed() const
{
    return true;
}
...
template<class CloudType>
bool Foam::ClusterLookupTableInjection<CloudType>::validInjection
(
    const label
)
{
